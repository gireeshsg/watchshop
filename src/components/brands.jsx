...
{/*           
          ...
          <li className='nav-item' onClick={()=>{setmenu("bestseller")}}><Link style={{textDecoration:'none'}} to='/brands'>brands</Link>{menu==="brands"?<hr/>:<></>}</li>
          {/* // <li className="nav-item">
...
<button onClick={brands1} class="picture-button"></button>
             
<button onClick={brands1} class="picture-button2"></button>

<button onClick={brands1} class="picture-button3"></button>

<button onClick={brands1} class="picture-button4"></button>   </div>
<button onClick={brands1} class="picture-button5"></button>
    </div>
